...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('students.index'))->with('success', 'User created.');
    }
    ...
    public function update(ProfileUpdateRequest $request): RedirectResponse
    {
        ...
        return redirect(route('students.index'))->with('success', 'User updated.');
    }
    ...
    public function destroy(Request $request, User $teacher): RedirectResponse
    {
        ...
        return redirect(route('students.index'))->with('success', 'User deleted.');
        ;
    }
}
